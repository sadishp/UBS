...
public class EventsControllerTest {
    ...
    public void createEvent() throws Exception {
         ...
         *         "id": 3,
         *         "login": "teresa",
         *         "avatar_url": "https://avatars.com/teresa"
         *     },
         *     "repo": {
         *         "id": 1,
         *         "name": "seema/lakshmi",
         *         "url": "https://github.com/seema/lakshmi"
         *     },
         *     "created_at": "2018-12-28 01:29:02"
         * }
         */
        String json = "{\"id\": 1, \"type\": \"PushEvent\", \"actor\": {\"id\": 3, \"login\": \"teresa\", \"avatar_url\": \"https://avatars.com/teresa\"}, \"repo\": {\"id\": 1, \"name\": \"seema/lakshmi\", \"url\": \"https://github.com/seema/lakshmi\"}, \"created_at\": \"2018-12-28 01:29:02\"}";
         ...
         *         "id": 2,
         *         "login": "andy9",
         *         "avatar_url": "https://avatars.com/andy9"
         *     },
         *     "repo": {
         *         "id": 2,
         *         "name": "dualipa/christina",
         *         "url": "https://github.com/dualipa/christina"
         *     },
         *     "created_at": "2018-12-29 20:31:36"
         * }
         */
        json = "{\"id\": 2, \"type\": \"PushEvent\", \"actor\": {\"id\": 2, \"login\": \"andy9\", \"avatar_url\": \"https://avatars.com/andy9\"}, \"repo\": {\"id\": 2, \"name\": \"dualipa/christina\", \"url\": \"https://github.com/dualipa/christina\"}, \"created_at\": \"2018-12-29 20:31:36\"}";
         ...
         *         "id": 1,
         *         "login": "drake99",
         *         "avatar_url": "https://avatars.com/drake99"
         *     },
         *     "repo": {
         *         "id": 1,
         *         "name": "seema/lakshmi",
         ...
         * }
         */
        json = "{\"id\": 3, \"type\": \"PushEvent\", \"actor\": {\"id\": 1, \"login\": \"drake99\", \"avatar_url\": \"https://avatars.com/drake99\"}, \"repo\": {\"id\": 1, \"name\": \"seema/lakshmi\", \"url\": \"https://github.com/seema/lakshmi\"}, \"created_at\": \"2018-12-31 00:02:09\"}";
         ...
         * }
         */
        json = "{\"id\": 4, \"type\": \"PushEvent\", \"actor\": {\"id\": 1, \"login\": \"drake99\", \"avatar_url\": \"https://avatars.com/drake99\"}, \"repo\": {\"id\": 2, \"name\": \"dualipa/christina\", \"url\": \"https://github.com/dualipa/christina\"}, \"created_at\": \"2018-12-31 16:18:49\"}";
    ...
    public void findEventById() throws Exception {
         ...
         * }
         */
        String res = "{\"id\": 1, \"type\": \"PushEvent\", \"actor\": {\"id\": 3, \"login\": \"teresa\", \"avatar_url\": \"https://avatars.com/teresa\"}, \"repo\": {\"id\": 1, \"name\": \"seema/lakshmi\", \"url\": \"https://github.com/seema/lakshmi\"}, \"created_at\": \"2018-12-28 01:29:02\"}";
    ...
    public void findAllEventsByRepoId() throws Exception {
         ...
         * ]
         */
        String res = "[{\"id\": 1, \"type\": \"PushEvent\", \"actor\": {\"id\": 3, \"login\": \"teresa\", \"avatar_url\": \"https://avatars.com/teresa\"}, \"repo\": {\"id\": 1, \"name\": \"seema/lakshmi\", \"url\": \"https://github.com/seema/lakshmi\"}, \"created_at\": \"2018-12-28 01:29:02\"}, {\"id\": 3, \"type\": \"PushEvent\", \"actor\": {\"id\": 1, \"login\": \"drake99\", \"avatar_url\": \"https://avatars.com/drake99\"}, \"repo\": {\"id\": 1, \"name\": \"seema/lakshmi\", \"url\": \"https://github.com/seema/lakshmi\"}, \"created_at\": \"2018-12-31 00:02:09\"}]";
    ...
    public void findAllEventsByActorId() throws Exception {
         ...
         * ]
         */
        String res = "[{\"id\": 3, \"type\": \"PushEvent\", \"actor\": {\"id\": 1, \"login\": \"drake99\", \"avatar_url\": \"https://avatars.com/drake99\"}, \"repo\": {\"id\": 1, \"name\": \"seema/lakshmi\", \"url\": \"https://github.com/seema/lakshmi\"}, \"created_at\": \"2018-12-31 00:02:09\"}, {\"id\": 4, \"type\": \"PushEvent\", \"actor\": {\"id\": 1, \"login\": \"drake99\", \"avatar_url\": \"https://avatars.com/drake99\"}, \"repo\": {\"id\": 2, \"name\": \"dualipa/christina\", \"url\": \"https://github.com/dualipa/christina\"}, \"created_at\": \"2018-12-31 16:18:49\"}]";
    ...
    public void findAllEventsByNonExistingRepoIdAndNonExistingActorId() throws Exception {
         ...
         */
        mockMvc.perform(get("/events/repos/4/actors/9"))
                .andExpect(status().isNotFound());
    }
    ...
    public void findAllEventsByNonExistingRepoIdAndActorId() throws Exception {
         ...
         */
        mockMvc.perform(get("/events/repos/4/actors/8"))
                .andExpect(status().isNotFound());
    }
    ...
    public void findAllEventsByRepoIdAndNonExistingActorId() throws Exception {
         ...
         */
        mockMvc.perform(get("/events/repos/1/actors/9"))
                .andExpect(status().isNotFound());
    }
    ...
    public void findAllEvents() throws Exception {
         ...
         * ]
         */
        String res = "[{\"id\": 1, \"type\": \"PushEvent\", \"actor\": {\"id\": 3, \"login\": \"teresa\", \"avatar_url\": \"https://avatars.com/teresa\"}, \"repo\": {\"id\": 1, \"name\": \"seema/lakshmi\", \"url\": \"https://github.com/seema/lakshmi\"}, \"created_at\": \"2018-12-28 01:29:02\"}, {\"id\": 2, \"type\": \"PushEvent\", \"actor\": {\"id\": 2, \"login\": \"andy9\", \"avatar_url\": \"https://avatars.com/andy9\"}, \"repo\": {\"id\": 2, \"name\": \"dualipa/christina\", \"url\": \"https://github.com/dualipa/christina\"}, \"created_at\": \"2018-12-29 20:31:36\"}, {\"id\": 3, \"type\": \"PushEvent\", \"actor\": {\"id\": 1, \"login\": \"drake99\", \"avatar_url\": \"https://avatars.com/drake99\"}, \"repo\": {\"id\": 1, \"name\": \"seema/lakshmi\", \"url\": \"https://github.com/seema/lakshmi\"}, \"created_at\": \"2018-12-31 00:02:09\"}, {\"id\": 4, \"type\": \"PushEvent\", \"actor\": {\"id\": 1, \"login\": \"drake99\", \"avatar_url\": \"https://avatars.com/drake99\"}, \"repo\": {\"id\": 2, \"name\": \"dualipa/christina\", \"url\": \"https://github.com/dualipa/christina\"}, \"created_at\": \"2018-12-31 16:18:49\"}]";
